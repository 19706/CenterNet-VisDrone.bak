    """[summary]
    会生成一个新的image文件夹（images_xml），貌似生成的图片和旧的图片是一样的，所以可以忽略
    Returns:
        [type]: [description]
    """
import cv2
...
output_ann_folder = os.path.join('/home/prototype/Downloads/CenterNet-master/data/visdrone2/annotations_xml')
output_img_folder = os.path.join('/home/prototype/Downloads/CenterNet-master/data/visdrone2/images_xml')
