...
# 把下面的路径改为自己的路径即可
file_path_img = '../../data/VisDrone2020-DET/VisDrone2019-DET-train/images'
file_path_xml = '../../data/VisDrone2020-DET/VisDrone2019-DET-train/annotations_xml'
save_file_path = '../../data/VisDrone2020-DET/VisDrone2019-DET-train/output'
